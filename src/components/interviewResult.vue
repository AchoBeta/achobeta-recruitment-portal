...
const comments = ref<commentType>({
  ...
  express: 2,
  evalute:
    "fdsafd反对凯撒JFK但是JFK理解昂的考虑时间刻录机考虑的是解放开绿灯撒加风口浪尖的离开结案方式考虑到就",
  suggest: "吃屁",
  playback:
    "https://meeting.tencent.com/v2/cloud-record/share?id=23cbfbc6-723e-42ff-85aa-78f675dc3af8&from=3",
});
...
onMounted(() => {
  ...
  getInterviewComment(storage.token, interviewId.value)
    .then((res) => {
      console.log(res);
        ...
        <div>
          ...
          <n-flex vertical v-if="is">
            ...
            <div class="last-comment">
              ...
              <a :href="comments.playback" class="comment-content"
                >点我跳转😫👩‍👧‍👦</a
              >
            </div>
          </n-flex>
